      ...
      <div className="container-wide">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Vse kar potrebujete za <span className="gradient-text">profesionalne etikete</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group bg-card rounded-2xl p-6 lg:p-8 shadow-md border border-border/50 card-hover opacity-0 animate-fade-up"
